...
class TestItemReviews(unittest.TestCase):
    def setUp(self):
        self.customer1 = ItemReview("Patrick", "8192104615", "patrick@gmail.com", "5", "4", "5")
        self.customer2 = ItemReview("Alyssa", "7102487366", "alyssa@gmail.com", "4", "5", "3")
        self.customer3 = ItemReview("Jose", "7328449299", "jose@gmail.com", "4", "4", "4")
        self.customer4 = ItemReview("Karen", "8773934443", "karen@gmail.com", "1", "1", "1")
        self.customer5 = ItemReview("Pat", "8129104165", "pat@gmail.com", "5", "3", "5")
        self.customer6 = ItemReview("Rick", "1892401651", "rick@gmail.com", "4", "4", "3")
